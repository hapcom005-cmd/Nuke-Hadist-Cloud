...
(async () => {
    ...
    await page.evaluate(() => {
        ...
        const btn = buttons.find(b => b.innerText.includes('Tafsir Lengkap'));
        if (btn) {
    ...
    const html = await page.evaluate(() => {
        const t = document.querySelector('.tafsir-kemenag-container');
        return t ? t.innerHTML.substring(0, 1000) : "No tafsir body";
    });
    console.log("Panel Content:", html);
    
    await page.screenshot({ path: 'screenshot_panel_correct.png' });
