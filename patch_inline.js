...
const startIndex = lines.findIndex(l => l.includes('window.switchTafsirTab = function(tabName) {'));
if (startIndex === -1) {
...
const correctCode = fs.readFileSync('correct_code_inline.js', 'utf8');
...
console.log('Inline patch applied successfully!');
