...
const targetFunction = `function getAudioUrl(surahNo, ayatNo) {
            ...
            // FITUR FALLBACK OFFLINE DATABASE (SUDAIS)
            if (reciter === "offline_sudais") {
                return 'QuranHadist/data/audio/sudais/ayat/' + formatNumber(surahNo) + formatNumber(ayatNo) + '.mp3';
            }
...
console.log('Fixed offline fallback for Sudais!');
